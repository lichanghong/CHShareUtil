#
#  Be sure to run `pod spec lint CHShareUtil.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "李长鸿"
  # s.authors            = { "李长鸿" => "lichanghong@b.360.cn" }
  # s.social_media_url   = "http://twitter.com/李长鸿"
